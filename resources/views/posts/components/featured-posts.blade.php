...
<div class="row flex-column align-items-start justify-content-between">
    <div class="col-12">
        <div class="row w-100">
            ...
            <div class="pl-1 col-8 col-sm-9 col-md-12 col-xl-8 text-left text-xlg-center m-auto"><a style="font-size: 16px" href="{{ url('company/'.$item->slug) }}">{{ $item->company_name }}</a></div>
        </div>
        <div class="row my-2">
