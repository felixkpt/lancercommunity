...
<div class="card p-4 text-start">
    <form action="{{ route($route) }}" method="post">
        ...
        <p class="mb-0">
            ...
            <i style="font-size:20px" class="ti-star <?= ($rating_temp <= $rating)  ? 'text-lc-warning' : ('') ?>" id="{{ $rating_temp }}" title="Rate {{ $rating_temp }}/10"></i>
            @endforeach
        ...
        <hr >
        <div class="row">
            <div class="col-md-4"><button class="btn btn-lg px-4 secondary-btn">Submit review</submit></div>
        </div>
    </form>
</div>
