...
class HomeController extends Controller
{
    ...
    public function index() {
        ...
        $title = 'Reviews & Ratings of companies and websites all in one place';
        $post = null;
        if ($option) {
        ...
        $description = $slider_description = 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eos eveniet amet excepturi voluptates dolorem totam ad quod hic, porro accusamus, repellat, corrupti at obcaecati ducimus, dolor quibusdam sequi nemo inventore?';
        $slides = [
